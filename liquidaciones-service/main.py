...
from app.routes.liquidacion import router as liquidacion_router
...
SERVICE_NAME = os.getenv("SERVICE_NAME", "liquidaciones-service")
...
app = FastAPI(
    title=SERVICE_NAME,
    description=f"Microservicio de liquidaciones siguiendo principios Clean Code y Twelve-Factor App",
