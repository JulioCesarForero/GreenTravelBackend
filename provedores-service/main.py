...
from app.routes.provedor import router as provedor_router
...
app = FastAPI(
    title=SERVICE_NAME,
    description=f"Microservicio de proveedores siguiendo principios Clean Code y Twelve-Factor App",
